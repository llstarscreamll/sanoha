<div class="col-md-6">
    ...
    {!! Form::model($search_input, ['route' => Route::currentRouteName(), 'method' => 'GET', 'class' => 'hidden-print' , 'name' => 'search', 'id' => 'search']) !!}

            <div class="input-group">
                
                {!! Form::text('find', null, ['placeholder' => 'Buscar por destino, placa, nombre o apellido de responsable...', 'class' => 'form-control']) !!}
